...
```{r signum_plot, echo=FALSE}
x = seq(0, 1, by=0.01)
y_signum = sign(-0.5 + x)
y_signum[y_signum < 0] = 0
plot(x, y_signum, 'l', col='blue')
title("Signum function (tau=0.5)")
```
...
```{r sigmoid_plot, echo=FALSE}
alpha = 6
tau   = 0.5
y = 1 / (1 + exp(-alpha*(x - tau)))

plot(x, y, 'l', col='blue', ylim=c(0, 1))
lines(x, y_signum, lty=2)
title("Sigmoid function (alpha=6, tau=0.5)")
```
...
```{r powerlaw_plot1, fig.width=14, fig.keep='last', echo=FALSE}
layout(t(1:2))
...
citep('10.1186/1471-2105-7-S1-S7')
citep('10.1038/35019019')
citep('10.1186/1471-2105-9-559')
```
